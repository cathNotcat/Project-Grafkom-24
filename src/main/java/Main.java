...
//        kepala
        ...
        mixue.get(4).scaleObject(1.5f, 1.5f, 1.5f);
        mixue.get(4).translateObject(-0.5f, -0.25f, 0.0f);
        ...
        mixue.get(5).rotateObject((float) Math.toRadians(25f), 0f, 0f, 1f);
        mixue.get(5).translateObject(-0.30f, -0.52f, 0.0f);
...
//        tangan kiri
        ...
        mixue.get(6).scaleObject(0.5f, 1.2f, 1.5f);
        mixue.get(6).rotateObject((float) Math.toRadians(-45f), 0f, 0f, 1f);
        mixue.get(6).rotateObject((float) Math.toRadians(180f), 1f, 0f, 0f);

        mixue.get(6).translateObject(-0.7f, -0.42f, 0.0f);
        ...
        mixue.get(7).scaleObject(0.02f, 0.05f, 0.3f);
        mixue.get(7).rotateObject((float) Math.toRadians(90f), 1f, 0f, 0f);
        mixue.get(7).translateObject(-0.79f, -0.45f, 0.0f);

        //mata
        mixue.get(4).getChildObject().add(new Sphere(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)
                ),
        ...
        mixue.get(4).getChildObject().get(0).scaleObject(0.3f, 0.4f, 0f);
        mixue.get(4).getChildObject().get(0).translateObject(-0.55f, -0.25f, 0.0f);

        mixue.get(4).getChildObject().get(0).getChildObject().add(new Circle(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)
                ),
        ...
        mixue.get(4).getChildObject().get(0).getChildObject().get(0).scaleObject(0.1f, 0.3f, 0f);
        mixue.get(4).getChildObject().get(0).getChildObject().get(0).translateObject(-0.53f, -0.25f, 0.0f);

        mixue.get(4).getChildObject().add(new Circle(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)
                ),
        ...
        mixue.get(4).getChildObject().get(1).scaleObject(0.3f, 0.4f, 0f);
        mixue.get(4).getChildObject().get(1).translateObject(-0.45f, -0.25f, 0.0f);

        mixue.get(4).getChildObject().get(1).getChildObject().add(new Circle(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)
                ),
        ...
        mixue.get(4).getChildObject().get(1).getChildObject().get(0).scaleObject(0.1f, 0.3f, 0f);
        mixue.get(4).getChildObject().get(1).getChildObject().get(0).translateObject(-0.43f, -0.25f, 0.0f);
//
        mixue.get(4).getChildObject().add(new Sphere(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
        ...
        mixue.get(4).getChildObject().get(2).scaleObject(0.03f, 0.03f, 0.1f);
        mixue.get(4).getChildObject().get(2).translateObject(-0.5f, -0.3f, 0.0f);
...
//            objects.get(0).rotateObject((float) Math.toRadians(0.1f), 1.0f, 0.0f, 0.0f);
            ...
            if (posisi_Kepala >= batas_Kepala) {
                ...
                mixue.get(4).rotateObject((float) Math.toRadians(0.1f), 0f, 0f, 1f);
            }
            for(Object object:mixue){
//                Vector3f obj = object
//                object.rotateObject((float) Math.toRadians(0.1f), 0f, 0f, 1f);
//                object.rotateObject((float) Math.toRadians(0.1f), 0f, 0f, 1f);
//                object.scaleObject(1.001f, 1.001f, 1.001f);

//                if (object >= batas_Kepala){
//
//                }
            }
